...
run: stop build
	cd core && ./core ../config.json ../3d-visualizer/static/replays/ ./data $(PLAYER1_ID) $(PLAYER2_ID) > /dev/null & cd ..
...
debug: stop build
	...
	$(MARTIN)/martin $(PLAYER2_ID) &
	cd core && ./core ../config.json ../3d-visualizer/static/replays/ ./data $(PLAYER1_ID) $(PLAYER2_ID) && cd ..
